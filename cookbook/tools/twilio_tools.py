...
from ethosian.tools.twilio import TwilioTools

"""
Example showing how to use the Twilio Tools with ethosian.
...
agent.print_response(
    f"Can you send an SMS saying 'Your package has arrived' to {
        receiver_phone_number} from {sender_phone_number}?"
)
