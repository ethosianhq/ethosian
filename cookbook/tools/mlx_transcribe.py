...
from ethosian.tools.mlx_transcribe import MLXTranscribe

# Get audio files from storage/audio directory
ethosian_root_dir = Path(__file__).parent.parent.parent.resolve()
audio_storage_dir = ethosian_root_dir.joinpath("storage/audio")
