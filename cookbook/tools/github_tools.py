...
from ethosian.tools.github import GithubTools

agent = Agent(
    instructions=[
        "Use your tools to answer questions about the repo: ethosianhq/ethosian",
...
# agent.print_response("Create a repo called ethosian-test and add description hello", markdown=True)
