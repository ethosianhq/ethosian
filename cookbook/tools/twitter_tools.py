...
from ethosian.tools.twitter import TwitterTools
...
agent = Agent(
    instructions=[
        "Use your tools to interact with Twitter as the authorized user @ethosianhq",
...
agent.print_response(
    "Can you retrieve information about this user https://x.com/ethosianhq ", markdown=True)

# # Example usage: Reply To a Tweet
# agent.print_response(
#     "Can you reply to this post as a general message as to how great this project is:https://x.com/ethosianhq/status/1836101177500479547",
#     markdown=True,
# )
...
# agent.print_response(
#     "Can a send direct message to the user: https://x.com/ethosianhq assking you want learn more about them and a link to their community?",
#     markdown=True,
# )
