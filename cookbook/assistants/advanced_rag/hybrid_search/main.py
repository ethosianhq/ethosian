...
# pip install llama-index-core llama-index-readers-file llama-index-retrievers-bm25 llama-index-embeddings-openai llama-index-llms-openai ethosian
...
from ethosian.knowledge.llamaindex import LlamaIndexKnowledgeBase

# Set up the data directory
data_dir = Path(__file__).parent.parent.parent.joinpath(
    "wip", "data", "paul_graham")
if data_dir.is_dir():
...
retriever = QueryFusionRetriever(
    [
        ...
        BM25Retriever.from_defaults(
            docstore=index.docstore, similarity_top_k=2),  # BM25 retrieval
    ],
    num_queries=1,
    use_async=True,
)
