# Import necessary modules from the ethosian library
from ethosian.knowledge.pdf import PDFUrlKnowledgeBase
from ethosian.vectordb.lancedb.lancedb import LanceDb
from ethosian.embedder.ollama import OllamaEmbedder
from ethosian.assistant import Assistant
from ethosian.storage.assistant.sqllite import SqlAssistantStorage
...
assistant = Assistant(
    ...
    # Use traditional RAG (Retrieval-Augmented Generation)
...
assistant.print_response(
    "What is the first step of making Gluai Buat Chi from the knowledge base?", markdown=True)
