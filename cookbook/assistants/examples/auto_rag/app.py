...
from ethosian.document.reader.text import TextReader
from ethosian.document.reader.docx import DocxReader
from ethosian.document.reader.csv_reader import CSVReader
...
def main() -> None:
    ...
    llm_model = st.sidebar.selectbox(
        "Select LLM", options=["gpt-4-turbo", "gpt-3.5-turbo"])
