...
pip install llama-index-core llama-index-readers-file llama-index-embeddings-openai ethosian
"""
...
assistant = Assistant(knowledge_base=knowledge_base,
                      search_knowledge=True, debug_mode=True, show_tool_calls=True)
