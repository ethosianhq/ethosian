...
from ethosian.vectordb.pineconedb import PineconeDB
from ethosian.knowledge.website import WebsiteKnowledgeBase

api_key = os.getenv("PINECONE_API_KEY")
index_name = "ethosian-website-index"
...
knowledge_base = WebsiteKnowledgeBase(
    urls=["https://docs.ethosianhq.com/introduction"],
...
assistant.print_response("How does ethosian work?")
