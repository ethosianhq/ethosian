...
def create_assistant(
    ...
    if yfinance:
        tools.append(YFinanceTools(stock_price=True,
                     stock_fundamentals=True, analyst_recommendations=True))
...
def main() -> None:
    ...
    yfinance = st.sidebar.checkbox(
        "YFinance", value=False, on_change=clear_assistant)
