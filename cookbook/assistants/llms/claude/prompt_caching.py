...
assistant.print_response(
    "Give me a one line summary of this book", markdown=True, stream=True)
print("Prompt cache creation tokens: ",
      assistant.llm.metrics["cache_creation_tokens"])  # type: ignore
print("Prompt cache read tokens: ",
      assistant.llm.metrics["cache_read_tokens"])  # type: ignore
