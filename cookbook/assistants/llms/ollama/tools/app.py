...
def main() -> None:
    ...
    llm_id = st.sidebar.selectbox(
        "Select LLM", options=["hermes2pro-llama3", "llama3"]) or "hermes2pro-llama3"
    ...
    yfinance_tools = st.sidebar.checkbox(
        "Yfinance", value=yfinance_tools_enabled)
    ...
    ddg_search = st.sidebar.checkbox(
        "DuckDuckGo Search", value=ddg_search_enabled)
