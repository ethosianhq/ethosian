"""
1. Run: `pip install openai lancedb tantivy pypdf sqlalchemy ethosian cohere` to install the dependencies
...
from ethosian.reranker.cohere import CohereReranker
...
knowledge_base = PDFUrlKnowledgeBase(
    ...
    vector_db=LanceDb(
        ...
        reranker=CohereReranker(
            model="rerank-multilingual-v3.0"),  # Add a reranker
    ),
)
