"""
1. Run: `pip install openai duckduckgo-search newspaper4k lxml_html_clean ethosian` to install the dependencies
2. Run: `python cookbook/teams/01_hn_team.py` to run the agent
"""

from ethosian.agent import Agent
from ethosian.tools.hackernews import HackerNews
