"""
1. Install dependencies using: `pip install openai ethosian`
...
from ethosian.utils.string import hash_string_sha256
from ethosian.utils.web import open_html_file
...
class GameOutput(BaseModel):
    ...
    instructions: str = Field(...,
                              description="Instructions how to play the game")


class QAOutput(BaseModel):
    reasoning: str = Field(..., description="Explain your reasoning")
    correct: bool = Field(
        False, description="Does the game pass your criteria?")
