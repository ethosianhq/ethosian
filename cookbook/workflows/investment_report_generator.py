"""
1. Install dependencies using: `pip install openai yfinance ethosian`
...
research_analyst_report = str(
    reports_dir.joinpath("research_analyst_report.md"))
...
if __name__ == "__main__":
    ...
    report: Iterator[RunResponse] = investment_report_generator.run(
        companies=companies)
